...
public static class StorePreview {
    ...
    static System.Collections.IEnumerator Frames() {
        ...
        foreach(var page in new[]{"Library","Downloads","Connect Mac","Settings"}) {
            ...
            app.Preview(camera,"{\"schemaVersion\":1,\"connected\":true,\"apps\":[{\"packageName\":\"preview.only\",\"title\":\"Quest sample · preview only\",\"versionName\":\"1.0\",\"size\":52428800,\"primaryAction\":{\"label\":\"Download\",\"enabled\":true}}],\"storage\":{\"label\":\"50 MB\",\"files\":1},\"settings\":{\"deleteAfterInstall\":true}}",page);
