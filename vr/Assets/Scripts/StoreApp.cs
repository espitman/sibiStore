...
public sealed class StoreApp : MonoBehaviour {
    ...
    void BuildPanel(Camera eye) {
        ...
        var rotate=Button(root.transform,"Rotate",24,710,190,58,()=>{},false).gameObject.AddComponent<PanelGrabHandle>();rotate.Initialize(root.transform,PanelManipulationMode.Rotate);
        Label(root.transform,"Title bar: move\nRotate: hold + aim\nTrigger or pinch",30,474,180,116,18,Muted);
